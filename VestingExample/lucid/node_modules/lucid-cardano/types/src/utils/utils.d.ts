...
import { Address, AddressDetails, Assets, CertificateValidator, Credential, Datum, DatumHash, KeyHash, MintingPolicy, NativeScript, Network, PolicyId, PrivateKey, PublicKey, RewardAddress, Script, ScriptHash, Slot, SpendingValidator, Unit, UnixTime, UTxO, Validator, WithdrawalValidator } from "../types/mod.js";
...
export declare function fromScriptRef(scriptRef: Core.ScriptRef): Script;
export declare function toScriptRef(script: Script): Core.ScriptRef;
...
export declare function applyParamsToScript<T extends unknown[] = Data[]>(plutusScript: string, params: [...T], shape?: TSchema): string;
