...
import { coreToUtxo, createCostModels, fromHex, paymentCredentialOf, toHex, Utils, utxoToCore, } from "../utils/mod.js";
...
export class Lucid {
    ...
    async datumOf(utxo, shape) {
        ...
        return shape ? Data.from(utxo.datum, shape) : utxo.datum;
    }
    /**
